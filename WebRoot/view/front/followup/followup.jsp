...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/front/followup.js?v=${vs}"></script>
...
<body style="background:#fafafa;" class="easyui-layout">
	...
	<div data-options="region:'center',href:'${ctx}/followup/followupContent',onLoad:initFollowup">
