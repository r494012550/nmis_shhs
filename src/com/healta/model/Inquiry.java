...
import com.healta.model.base.BaseInquiry;
...
public class Inquiry extends BaseInquiry<Inquiry> {
	...
	public Inquiry getFirstByorderid(Integer orderid) {
		return dao.findFirst("SELECT TOP 1 * FROM inquiry WHERE studyorderfk = ?", orderid);
	}
