...
import com.healta.model.base.BasePreviousHistory;
...
public class PreviousHistory extends BasePreviousHistory<PreviousHistory> {
	public static final PreviousHistory dao = new PreviousHistory().dao();
