...
public class Dcm2Jpg {
    ...
    private static ResourceBundle rb =
        ResourceBundle.getBundle("com.healta.plugin.dcm.dcm2jpg_messages");
    ...
    public void convert(File src,String dest) {
    	initImageWriter("JPEG",null,null,null,null);
    	
    	mconvert(src, new File(dest));
    }
