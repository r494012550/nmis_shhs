...
public class StoreSCP {
    ...
    private static ResourceBundle rb =
        ResourceBundle.getBundle("com.healta.plugin.dcm.store_messages");
    ...
    private final BasicCStoreSCP cstoreSCP = new BasicCStoreSCP("*") {
        ...
        protected void store(Association as, PresentationContext pc,
            ...
            try {
                ...
                dcm2Jpg.convert(dest, dest.getParent()+"\\"+dest.getName().replace(".dcm", ".jpg"));
    ...
    private static void renameTo(Association as, File from, File dest)
            throws IOException {
        log.info(as+"{}: M-RENAME "+from+"{} to {}"+dest);
    ...
    private static void deleteFile(Association as, File file) {
        if (file.delete())
            log.info(as+"{}: M-DELETE {}"+ file);
        else
            log.warn(as+"{}: M-DELETE {} failed!"+ file);
    }
    ...
    public void configAll(String[] args){
    	try {
            ...
            log.error("dcmstroescp: " + e.getMessage());
        ...
        if (cl.hasOption("accept-unknown")) {
            ...
            Properties p = CLIUtils.loadProperties(
                    cl.getOptionValue("sop-classes", 
                            "resource:com/healta/plugin/dcm/storage-sop-classes.properties"),
                    null);
