...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/front/inquiring.js?v=${vs}"></script>
...
<body style="background:#fafafa;" class="easyui-layout">
	...
	<div data-options="region:'center',href:'${ctx}/inquiring/interrogationContent', onLoad:initInterrogation"></div>
	...
	<input id="employee_id_hidden" value="${employee_id}" type="hidden"/>
	<input id="projecturl"  value="${projecturl}" type="hidden">
	<input id="scanClientIp" value="${ip}" type="hidden">
	<input id="scanClientUserid" value="${user_id+990000}" type="hidden">
