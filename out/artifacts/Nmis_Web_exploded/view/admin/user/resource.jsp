...
<body>
		<div class="easyui-panel" data-options="fit:true" style="padding:10px;">
			<header style="color:#8aa4af;">${sessionScope.locale.get('admin.currentlocation.resource')}</header>
			<table id="resdg" class="easyui-treegrid" style="width:100%;"
				data-options="showFooter: true,iconCls: 'icon-ok',singleSelect:true,fit:true,toolbar:'#toolbar_div_resource',
				url:'${ctx}/getAllResource',autoRowHeight:true,fitColumns:true,idField:'rid',treeField:'display_${language}',animate:true,
				">
				<thead>
					<tr>
