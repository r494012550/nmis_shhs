...
//                name:thePlugins,
//                editor:this,
//                title: window.localStorage.getItem("name"),
...
//                    label:'确定',
//                    onclick:function () {
//                    	window.localStorage.setItem("text_flag",1);
//                        dialog.close(true);
//                        $('.edui-okbutton').remove();
//                    }
//                },
//                {
//                    className:'edui-okbutton',
//                    label:'取消',
//                    onclick:function () {
//                    	window.localStorage.setItem("text_flag",0);
//                        dialog.close(true);
//                        $('.edui-okbutton').remove();
//                    }
//                }]
	 ...
	 var me = this,thePlugins = 'text';
	    me.commands[thePlugins] = {
	        execCommand:function () {
	        	...
	        	alert(this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/text.jsp');
	            var dialog = new UE.ui.Dialog({
	                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/text.jsp',
	                name:thePlugins,
	                editor:this,
	                className:"cs-dialog-box",
	                title: '文本框',
	                cssRules:"width:500px;height:200px;",
	                buttons:[
	                {
...
//        execCommand:function () {
//            var dialog = new UE.ui.Dialog({
//                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/select.jsp',
//                name:thePlugins,
//                editor:this,
//                title: '下拉选',
...
//            var html = popup.formatHtml(
//                '<nobr>下拉选: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
//            if ( html ) {
...
UE.plugins['select'] = function () {
	 var me = this,thePlugins = 'select';
	    me.commands[thePlugins] = {
	        execCommand:function () {
	            var dialog = new UE.ui.Dialog({
	                ...
	                className:"cs-dialog-box",
	                title: window.localStorage.getItem("name"),
	                cssRules:"width:500px;height:180px;",
	                buttons:[
	                {
	                    className:'edui-okbutton',
	                    label:'确定',
	    ...
	    me.addListener( 'mouseover', function( t, evt ) {
	        ...
	        var el = evt.target || evt.srcElement;
	        var leipiPlugins = el.getAttribute('leipiplugins');
	        if ( /textarea|span/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
	            var html = popup.formatHtml(
...
//                             label:'确定',
//                             onclick:function () {
//                             	window.localStorage.setItem("s_flag",1);
//                                 dialog.close(true);
//                                 $('.edui-okbutton').remove();
//                             }
//                         },
...
//                             label:'取消',
//                             onclick:function () {
//                             	window.localStorage.setItem("s_flag",0);
//                                 dialog.close(true);
//                                 $('.edui-okbutton').remove();
//                             }
//                         }]
